...
" Normal text.
let s:bwc.plain = ['9e9e9e', 247]

" Pure and simple.
let s:bwc.snow = ['9e9e9e', 247]
let s:bwc.coal = ['000000', 16]

" All of the Gravel colors are based on a brown from Clouds Midnight.
let s:bwc.brightgravel   = ['444444', 238]
let s:bwc.lightgravel    = ['444444', 238]
let s:bwc.gravel         = ['444444', 238]
let s:bwc.mediumgravel   = ['444444', 238]
let s:bwc.deepgravel     = ['444444', 238]
let s:bwc.deepergravel   = ['444444', 238]
let s:bwc.darkgravel     = ['444444', 238]
let s:bwc.blackgravel    = ['444444', 238]
let s:bwc.blackestgravel = ['444444', 238]

" A color sampled from a highlight in a photo of a glass of Dale's Pale Ale on
" my desk.
let s:bwc.dalespale = ['AC960C', 221]

" A beautiful tan from Tomorrow Night.
let s:bwc.dirtyblonde = ['D78214', 222]

" Delicious, chewy red from Made of Code for the poppiest highlights.
" pink
let s:bwc.taffy = ['FF578F', 205]

" Another chewy accent, but use sparingly!
" green
let s:bwc.saltwatertaffy = ['00Af00', 34]
...
" * The cursor
" * A REPL prompt
" bright blasting blue
let s:bwc.tardis = ['00af87', 36]

" This one's from Mustang, not Florida!
" orange
let s:bwc.orange = ['ff8700', 208]

" A limier green from Getafe.
let s:bwc.lime = ['af87ff', 141]

" Rose's dress in The Idiot's Lantern.
let s:bwc.dress = ['FF5C87', 211]

" Another play on the brown from Clouds Midnight.  I love that color.
let s:bwc.toffee = ['BC8E5C', 137]

" Also based on that Clouds Midnight brown.
let s:bwc.coffee    = ['00ffff', 173]
let s:bwc.darkroast = ['d7875f', 173] " salmon!
...
call s:HL('Normal', 'darkroast', 'coal')
...
call s:HL('StatusLine',   'coal', 'darkroast',     'bold')
...
call s:HL('Comment',        'plain')
call s:HL('Todo',           'plain', 'bg', 'bold')
call s:HL('SpecialComment', 'plain', 'bg', 'bold')
